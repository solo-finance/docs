...
<Steps>
  ...
  <Step title="Optional: pre-flight coverage check">
    ...
    [Coverage check](/concepts/querying/coverage-check) for the full
    semantics.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="204 — query ran but no certificate">
    ...
    [coverage check](/concepts/querying/coverage-check) to see which furnishers
...
<CardGroup cols={2}>
  <Card title="How querying works" icon="magnifying-glass" href="/concepts/querying/overview">
  ...
  <Card title="Coverage check" icon="list-check" href="/concepts/querying/coverage-check">
    The non-billable soft check in depth.
  </Card>
  <Card title="Products" icon="boxes-stacked" href="/concepts/querying/products">
