...
- **Verification branches** are furnished events. The richest is **KYC**, which
  a [KYC certificate](/concepts/querying/kyc-certificate) query consolidates
...
- **Verified identity** — a [KYC certificate](/concepts/querying/kyc-certificate)
...
- **Fraud screening** — [screening list](/concepts/querying/screening-lists)
