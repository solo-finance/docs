...
[certificates](/concepts/querying/kyc-certificate), screening list queries never
...
Both endpoints take the standard [query request](/concepts/querying/overview):
...
<Note>
  ...
  [certificate endpoints](/concepts/querying/kyc-certificate#when-you-get-a-204)
  ...
  [`X-Ref-Id` header](/concepts/querying/overview#the-x-ref-id-header).
</Note>
