...
icon: 'file-signature'
---
import DashboardIdentityConsent from '/snippets/dashboard/identity-consent.mdx';
...
<AccordionGroup>
  ...
  <Accordion title="Does furnishing require consent?">
    ...
    [Furnishing](/api-overview/furnishing/overview) for the obligations that apply when
    contributing data.
  </Accordion>
</AccordionGroup>


<DashboardIdentityConsent />
## Related concepts
