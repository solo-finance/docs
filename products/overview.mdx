...
[Network consumption](/api-overview/querying/overview).
...
| [Bank-Specific Bad Actor List](/products/bank-specific-bad-actor-list) | Fraud & Financial Crime | Consumer | "Has this consumer violated a documented policy of this sponsor bank's subnetwork?" |
...
| Screen a consumer against your sponsor bank's subnetwork history | [Bank-Specific Bad Actor List](/products/bank-specific-bad-actor-list) |
