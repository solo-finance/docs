...
icon: 'id-card'
---
import DashboardQueryingKycCertificate from '/snippets/dashboard/querying-kyc-certificate.mdx';
...
query, run a [coverage check](/api-overview/querying/coverage-check) first.
...
<DashboardQueryingKycCertificate />
<CardGroup cols={2}>
